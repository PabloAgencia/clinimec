...
REM
REM  Enlace bueno: https://clinimec.creskio.com
REM ============================================================
cd /d "E:\Escritorio\Agencia Webs IA\clinimec"

echo.
echo  Publicando Clinimec
echo  --------------------------------------------
echo.
...
echo     https://clinimec.creskio.com
echo.
